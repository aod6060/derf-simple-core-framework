...
namespace index_buffer {
    ...
    void IndexBufferApp::handleEvent(SDL_Event* e) {

    }

    void IndexBufferApp::update(float delta) {
    ...
    void IndexBufferApp::reloadInit() {

    }

    void IndexBufferApp::reloadRelease() {
